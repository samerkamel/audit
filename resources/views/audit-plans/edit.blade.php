...
@section('title', __('Edit Audit Plan'))
  ...
  <div class="col-12">
    <div class="card mb-6">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">{{ __('Edit Audit Plan') }}: {{ $auditPlan->title }}</h5>
          ...
          <div class="row mt-4">
            <div class="col-12">
              <button type="submit" class="btn btn-primary me-3">
                <i class="icon-base ti tabler-device-floppy me-1"></i> {{ __('Update Audit Plan') }}
              </button>
