...
@section('title', 'Edit CAR Follow-up')
...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="d-flex justify-content-between align-items-center mb-6">
    <div>
      <h4 class="fw-bold mb-1">Edit Follow-up for CAR {{ $car->car_number }}</h4>
      <p class="text-muted mb-0">Update effectiveness review and verification</p>
    </div>
  ...
  @if($followUp->status === 'not_accepted')
  <div class="alert alert-danger alert-dismissible" role="alert">
    <h5 class="alert-heading mb-2">
      <i class="icon-base ti tabler-alert-triangle me-2"></i> Follow-up Not Accepted
    </h5>
    <p class="mb-0"><strong>Reason:</strong> {{ $followUp->rejection_reason }}</p>
  ...
  <!-- Follow-up Form -->
  <form action="{{ route('cars.follow-ups.update', [$car, $followUp]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
      ...
      <div class="card-body">
        <div class="mb-4">
          ...
          <textarea
            ...
            required>{{ old('effectiveness_review', $followUp->effectiveness_review) }}</textarea>
        ...
        <div class="mb-0">
          ...
          <textarea
            ...
            rows="6"
            placeholder="Describe objective evidence that supports your effectiveness assessment (e.g., metrics, observations, test results)...">{{ old('verification_evidence', $followUp->verification_evidence) }}</textarea>
      ...
      <div class="card-body">
        ...
        <div class="mb-4">
          ...
          <div class="list-group">
            @foreach($followUp->attachments as $index => $attachment)
            <div class="list-group-item d-flex justify-content-between align-items-center">
              ...
              <form action="{{ route('cars.follow-ups.remove-attachment', [$car, $followUp]) }}" method="POST" class="d-inline" onsubmit="return confirm('Remove this attachment?')">
                @csrf
                @method('DELETE')
        ...
        <div class="mb-4">
          <label class="form-label" for="attachments">Upload Additional Evidence/Attachments</label>
          <input
            type="file"
        ...
        <div class="mb-0">
          ...
          <textarea
            ...
            name="remarks"
            rows="4"
            placeholder="Any additional notes or observations...">{{ old('remarks', $followUp->remarks) }}</textarea>
          @error('remarks')
            <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <button type="submit" class="btn btn-primary">
            <i class="icon-base ti tabler-check me-1"></i> Update Follow-up
          </button>
        </div>
      </div>
    </div>
