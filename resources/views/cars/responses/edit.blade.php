...
@section('title', 'Edit CAR Response')
...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="d-flex justify-content-between align-items-center mb-6">
    <div>
      <h4 class="fw-bold mb-1">Edit Response to CAR {{ $car->car_number }}</h4>
      <p class="text-muted mb-0">Update root cause analysis and action plans</p>
    </div>
  ...
  <div class="alert alert-danger alert-dismissible" role="alert">
    <h5 class="alert-heading mb-2">
      <i class="icon-base ti tabler-alert-triangle me-2"></i> Response Rejected
    </h5>
  ...
  <!-- Response Form -->
  <form action="{{ route('cars.responses.update', [$car, $response]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
      ...
      <div class="card-body">
        <div class="mb-0">
          ...
          <textarea
            ...
            required>{{ old('root_cause', $response->root_cause) }}</textarea>
          @error('root_cause')
        ...
        <div class="row g-4">
          <div class="col-12">
            ...
            <textarea
              ...
              required>{{ old('correction', $response->correction) }}</textarea>
            @error('correction')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          ...
          <div class="col-md-6">
            ...
            <input
              ...
              value="{{ old('correction_target_date', $response->correction_target_date->format('Y-m-d')) }}"
        ...
        <div class="row g-4">
          <div class="col-12">
            ...
            <textarea
              ...
              required>{{ old('corrective_action', $response->corrective_action) }}</textarea>
          ...
          <div class="col-md-6">
            ...
            <input
              ...
              value="{{ old('corrective_action_target_date', $response->corrective_action_target_date->format('Y-m-d')) }}"
              placeholder="Select target date"
              required />
    ...
    <!-- Existing Attachments & New Uploads -->
    <div class="card mb-6">
      <div class="card-header">
        <h5 class="card-title mb-0">
        ...
        <div class="mb-4">
          ...
          <div class="list-group">
            ...
            <div class="list-group-item d-flex justify-content-between align-items-center">
              ...
              <form action="{{ route('cars.responses.remove-attachment', [$car, $response]) }}" method="POST" class="d-inline" onsubmit="return confirm('Remove this attachment?')">
                @csrf
                @method('DELETE')
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <button type="submit" class="btn btn-primary">
            <i class="icon-base ti tabler-send me-1"></i> Update & Re-Submit Response
          </button>
        </div>
      </div>
    </div>
