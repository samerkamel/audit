...
@section('title', 'Create Reminder Setting')

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-6">
        <div>
            <h4 class="fw-bold mb-1">Create Reminder Setting</h4>
            <p class="text-muted mb-0">Configure a new automatic reminder notification</p>
        </div>
    ...
    <form action="{{ route('reminder-settings.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        @error('entity_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="form-text text-muted">What type of item should trigger reminders?</small>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        @error('event_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="form-text text-muted">What event should trigger reminders?</small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-end gap-2">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="ti tabler-check me-1"></i> Create Reminder
            </button>
        </div>
    </form>
</div>
