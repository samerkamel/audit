...
@section('title', 'Create CheckList Group')
  ...
  <div class="col-12">
    <div class="card mb-6">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Create New CheckList Group</h5>
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code"
                value="{{ old('code') }}" placeholder="e.g., CLG-001" required>
              @error('code')
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control @error('quality_procedure_reference') is-invalid @enderror"
                ...
                value="{{ old('quality_procedure_reference') }}" placeholder="e.g., QP-03-01">
            ...
            <div class="col-12 mb-3">
              ...
              <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title"
                value="{{ old('title') }}" placeholder="Enter the group title..." required>
              @error('title')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="col-12 mb-3">
              ...
              <textarea class="form-control @error('description') is-invalid @enderror" id="description"
                ...
                placeholder="Describe the purpose of this checklist group...">{{ old('description') }}</textarea>
              @error('description')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control @error('department') is-invalid @enderror" id="department"
                name="department" value="{{ old('department') }}" placeholder="e.g., Commercial, General">
              @error('department')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
          ...
          <div class="row mt-4">
            <div class="col-12">
              <button type="submit" class="btn btn-primary me-3">
                <i class="icon-base ti tabler-device-floppy me-1"></i> Create Group
              </button>
