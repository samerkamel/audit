...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="alert alert-success alert-dismissible" role="alert">
    <h5 class="alert-heading mb-2">
      <i class="icon-base ti tabler-circle-check me-2"></i> Complaint Closed
    </h5>
    <p class="mb-0">
      This complaint was successfully resolved and closed on {{ $complaint->closed_at->format('F d, Y') }}
      @if($complaint->closedBy)
      by {{ $complaint->closedBy->name }}
      @endif
    </p>
  ...
  <div class="alert alert-danger alert-dismissible" role="alert">
    <h5 class="alert-heading mb-2">
      <i class="icon-base ti tabler-alert-triangle me-2"></i> Overdue Response
    </h5>
    <p class="mb-0">
      This complaint is overdue. Expected response date was {{ $complaint->response_date->format('F d, Y') }}.
    </p>
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>
  @endif
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      ...
      <div class="card mb-6">
        ...
        <div class="card-body">
          <div class="row g-4">
            <div class="col-md-6">
              <label class="form-label fw-semibold">Complaint Number</label>
            ...
            <div class="col-md-6">
              <label class="form-label fw-semibold">Expected Response Date</label>
              <p class="mb-0">
      ...
      <div class="card mb-6">
        <div class="card-header">
          <h5 class="card-title mb-0">Initial Response</h5>
        </div>
        <div class="card-body">
      ...
      <div class="card mb-6">
        <div class="card-header">
          <h5 class="card-title mb-0">Resolution Details</h5>
        </div>
        <div class="card-body">
          <div class="mb-4">
          ...
          <div class="row g-4">
            ...
            <div class="col-md-6">
              <label class="form-label fw-semibold">Resolved By</label>
              <p class="mb-0">
    ...
    <div class="col-lg-4">
      ...
      <div class="card mb-6">
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#acknowledgeModal">
            <i class="icon-base ti tabler-check me-1"></i> Acknowledge Complaint
          </button>
          @elseif($complaint->status === 'acknowledged')
          <form action="{{ route('complaints.investigate', $complaint) }}" method="POST" class="mb-3">
            @csrf
            <button type="submit" class="btn btn-warning w-100">
              <i class="icon-base ti tabler-search me-1"></i> Start Investigation
            </button>
          </form>
          ...
          <button type="button" class="btn btn-success w-100" data-bs-toggle="modal" data-bs-target="#resolveModal">
            <i class="icon-base ti tabler-circle-check me-1"></i> Resolve Complaint
          </button>
          @elseif($complaint->status === 'resolved' && $complaint->canBeClosed())
          <form action="{{ route('complaints.close', $complaint) }}" method="POST" onsubmit="return confirm('Are you sure you want to close this complaint?')">
            @csrf
            <button type="submit" class="btn btn-secondary w-100">
              <i class="icon-base ti tabler-lock me-1"></i> Close Complaint
            </button>
          </form>
          @endif
        </div>
      ...
      <div class="card mb-6">
        <div class="card-header">
          <h5 class="card-title mb-0">Corrective Action</h5>
        </div>
        <div class="card-body">
          <div class="mb-3">
            <label class="form-label fw-semibold">CAR Required</label>
            <p class="mb-0">
          ...
          <div class="alert alert-info mb-0" role="alert">
            <h6 class="alert-heading mb-2">CAR Generated</h6>
            <p class="mb-2">
          ...
          <form action="{{ route('complaints.generate-car', $complaint) }}" method="POST" onsubmit="return confirm('Generate CAR from this complaint?')">
            @csrf
            <button type="submit" class="btn btn-primary w-100">
              <i class="icon-base ti tabler-file-arrow-right me-1"></i> Generate CAR
            </button>
          </form>
          @endif
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Acknowledge Complaint</h5>
      ...
      <form action="{{ route('complaints.acknowledge', $complaint) }}" method="POST">
        ...
        <div class="modal-body">
          <div class="mb-3">
            <label class="form-label" for="initial_response">Initial Response <span class="text-danger">*</span></label>
            <textarea
              class="form-control"
              id="initial_response"
              name="initial_response"
              rows="6"
              placeholder="Provide initial acknowledgment and assessment of the complaint..."
              required></textarea>
          </div>
        </div>
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary">
            <i class="icon-base ti tabler-check me-1"></i> Acknowledge
          </button>
        </div>
      </form>
    </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="{{ route('complaints.resolve', $complaint) }}" method="POST">
        ...
        <div class="modal-body">
          <div class="mb-4">
            <label class="form-label" for="root_cause_analysis">Root Cause Analysis <span class="text-danger">*</span></label>
            <textarea
              class="form-control"
              id="root_cause_analysis"
              name="root_cause_analysis"
              rows="6"
              placeholder="Describe the root cause analysis of the complaint..."
              required></textarea>
          </div>
          <div class="mb-4">
            <label class="form-label" for="corrective_action">Corrective Action <span class="text-danger">*</span></label>
            <textarea
              class="form-control"
          ...
          <div class="mb-0">
            <label class="form-label" for="resolution">Resolution <span class="text-danger">*</span></label>
            <textarea
              class="form-control"
              id="resolution"
              name="resolution"
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-success">
            <i class="icon-base ti tabler-circle-check me-1"></i> Resolve
          </button>
        </div>
      </form>
    </div>
