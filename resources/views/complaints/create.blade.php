...
@section('title', __('Register Customer Complaint'))
...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="d-flex justify-content-between align-items-center mb-6">
    <div>
      <h4 class="fw-bold mb-1">{{ __('Register Customer Complaint') }}</h4>
      <p class="text-muted mb-0">{{ __('Record and track customer feedback and complaints') }}</p>
    </div>
    <a href="{{ route('complaints.index') }}" class="btn btn-label-secondary">
      <i class="icon-base ti tabler-arrow-left me-1"></i> {{ __('Back to Complaints') }}
    </a>
  </div>
        ...
        <div class="row g-4">
          ...
          <div class="col-12">
            ...
            <textarea
              ...
              rows="6"
              placeholder="{{ __('Provide detailed information about the complaint including what happened, when it occurred, and any other relevant details...') }}"
          ...
          <div class="col-md-4">
            ...
            <select
              ...
              <option value="product_quality" {{ old('complaint_category') == 'product_quality' ? 'selected' : '' }}>{{ __('Product Quality') }}</option>
              <option value="service_quality" {{ old('complaint_category') == 'service_quality' ? 'selected' : '' }}>{{ __('Service Quality') }}</option>
              <option value="delivery" {{ old('complaint_category') == 'delivery' ? 'selected' : '' }}>{{ __('Delivery') }}</option>
              <option value="documentation" {{ old('complaint_category') == 'documentation' ? 'selected' : '' }}>{{ __('Documentation') }}</option>
              <option value="technical_support" {{ old('complaint_category') == 'technical_support' ? 'selected' : '' }}>{{ __('Technical Support') }}</option>
              <option value="billing" {{ old('complaint_category') == 'billing' ? 'selected' : '' }}>{{ __('Billing') }}</option>
              <option value="other" {{ old('complaint_category') == 'other' ? 'selected' : '' }}>{{ __('Other') }}</option>
            </select>
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <button type="submit" class="btn btn-primary">
            <i class="icon-base ti tabler-check me-1"></i> {{ __('Register Complaint') }}
          </button>
        </div>
      </div>
    </div>
