...
<div class="container-xxl flex-grow-1 container-p-y">
  <div class="d-flex justify-content-between align-items-center mb-6">
    <div>
      <h4 class="fw-bold mb-1">Edit Complaint {{ $complaint->complaint_number }}</h4>
      <p class="text-muted mb-0">Update complaint information</p>
    </div>
    <a href="{{ route('complaints.show', $complaint) }}" class="btn btn-label-secondary">
      <i class="icon-base ti tabler-arrow-left me-1"></i> Back to Complaint
    </a>
  </div>
        ...
        <div class="row g-4">
          ...
          <div class="col-md-4">
            ...
            <select
              ...
              <option value="product_quality" {{ old('complaint_category', $complaint->complaint_category) == 'product_quality' ? 'selected' : '' }}>Product Quality</option>
              <option value="service_quality" {{ old('complaint_category', $complaint->complaint_category) == 'service_quality' ? 'selected' : '' }}>Service Quality</option>
              <option value="delivery" {{ old('complaint_category', $complaint->complaint_category) == 'delivery' ? 'selected' : '' }}>Delivery</option>
              <option value="documentation" {{ old('complaint_category', $complaint->complaint_category) == 'documentation' ? 'selected' : '' }}>Documentation</option>
              <option value="technical_support" {{ old('complaint_category', $complaint->complaint_category) == 'technical_support' ? 'selected' : '' }}>Technical Support</option>
              <option value="billing" {{ old('complaint_category', $complaint->complaint_category) == 'billing' ? 'selected' : '' }}>Billing</option>
              <option value="other" {{ old('complaint_category', $complaint->complaint_category) == 'other' ? 'selected' : '' }}>Other</option>
            </select>
          ...
          <div class="col-md-4">
            ...
            <select
              ...
              <option value="minor" {{ old('severity', $complaint->severity) == 'minor' ? 'selected' : '' }}>Minor</option>
              <option value="major" {{ old('severity', $complaint->severity) == 'major' ? 'selected' : '' }}>Major</option>
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <button type="submit" class="btn btn-primary">
            <i class="icon-base ti tabler-check me-1"></i> Update Complaint
          </button>
        </div>
      </div>
    </div>
