            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-2">
                    <li class="breadcrumb-item">
                        <a href="{{ route('notification-templates.index') }}">{{ __('Notification Templates') }}</a>
                    </li>
                    <li class="breadcrumb-item active">{{ __('Edit') }}</li>
                </ol>
            </nav>
            <h4 class="fw-bold mb-1">{{ __('Edit Template') }}: {{ $notificationTemplate->name }}</h4>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="ti tabler-info-circle me-2"></i>{{ __('Basic Information') }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">{{ __('System identifier (cannot be changed)') }}</small>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <label class="form-label" for="name">{{ __('Display Name') }} <span class="text-danger">*</span></label>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="ti tabler-mail me-2"></i>{{ __('Email Template') }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label" for="email_subject">{{ __('Email Subject') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-0">
                            <label class="form-label" for="email_body">{{ __('Email Body') }} <span class="text-danger">*</span></label>
                            ...
                            @error('email_body')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">{{ __('Supports plain text. Use placeholders like') }} <code>{user_name}</code> {{ __('for dynamic content.') }}</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="ti tabler-bell me-2"></i>{{ __('In-App Notification') }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label" for="notification_title">{{ __('Notification Title') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-0">
                            <label class="form-label" for="notification_message">{{ __('Notification Message') }} <span class="text-danger">*</span></label>
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="ti tabler-palette me-2"></i>{{ __('Appearance') }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label" for="notification_icon">{{ __('Icon') }}</label>
                        ...
                        <div class="mb-0">
                            <label class="form-label" for="notification_color">{{ __('Color') }}</label>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="ti tabler-send me-2"></i>{{ __('Delivery Channels') }}
                        </h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch">
                            ...
                            <label class="form-check-label" for="is_active">
                                <i class="ti tabler-toggle-right me-1"></i>{{ __('Template Active') }}
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="ti tabler-code me-2"></i>{{ __('Placeholders') }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <p class="text-muted small mb-2">{{ __('Available for this template:') }}</p>
